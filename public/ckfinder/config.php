...
$config['LicenseName'] = $config['editor']['license_name'];
$config['LicenseKey'] = $config['editor']['license_key'];
...
*/
$config['Images'] = Array(
		'maxWidth' => $config['editor']['max_image_width'],
		'maxHeight' => $config['editor']['max_image_height'],
		'quality' => 80);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $config['editor']['max_doc_size'],
		'allowedExtensions' => 'html,htm,pdf,doc,docx,rtf,txt,xls,xlsx,ppt,pptx,pps,ppsx,zip,csv',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $config['editor']['max_image_size'],
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => $config['editor']['max_media_size'],
